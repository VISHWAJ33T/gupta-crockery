  ...
  return (
    <div className=" mx-[15px] mt-5 mb-6 gap-x-3 flex sm:mx-[20px] pb-3 overflow-x-scroll shadow-2xl">
      {user && Admins && Admins.includes(user.email) && (
        <div className="w-[100%] flex justify-end absolute right-4 p-1 gap-x-1">
          <Link href="Admin729/editCategoriesImg" class="edit-button">
      ...
      {/* ******************************************Steel****************************************** */}
      <SingleCategory heading="Steel" />
      {/* ******************************************Copper****************************************** */}
      <SingleCategory heading="Copper" />
      {/* ******************************************Plastic****************************************** */}
      <SingleCategory heading="Plastic" />
      {/* ******************************************Brass****************************************** */}
      <SingleCategory heading="Brass" />
      {/* ******************************************Aluminium****************************************** */}
      <SingleCategory heading="Aluminium" />
      {/* ******************************************Wooden****************************************** */}
      <SingleCategory heading="Wooden" />
      {/* ******************************************Glass****************************************** */}
